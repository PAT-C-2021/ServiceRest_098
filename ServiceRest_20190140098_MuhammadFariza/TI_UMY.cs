...
namespace ServiceRest_20190140098_MuhammadFariza
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-FFUAFKEG;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=Fariza2001");
            string query = String.Format("insert into dbo.Mahasiswaa values ('{0}', '{1}','{2}','{3}')", mhs.nama, mhs.nim, mhs.prodi, mhs.angkatan);
            //NIM = '{0}'", nim
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-FFUAFKEG;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=Fariza2001");
            string query = "select Nama, NIM, Prodi, Angkatan from dbo.Mahasiswaa";
        ...
        public Mahasiswa GetMahasiswaByNIM(string nim)
        {
            Mahasiswa mhs = new Mahasiswa();
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-FFUAFKEG;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=Fariza2001");
            string query = String.Format("select Nama, NIM, Prodi, Angkatan from dbo.Mahasiswaa where NIM = '{0}'", nim);
